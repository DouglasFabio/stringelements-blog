...
export default function PublicarNoticia(props) {
    ...
    const onSubmit = (data) => {
        ...
        const url = '/api/PublicarNoticia/' + props.id;
        var args = {
            method: 'PUT',
            headers: {
    ...
    return (
        <Modal size="md" centered show={modalShow}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <Modal.Header>
                    <Modal.Title>Publicação de notícias</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    Deseja publicar a notícia na página inicial?
                    <div hidden>
                ...
                <Modal.Footer>
                    <BusyButton variant="success" type="submit" label="Publicar" busy={busy} />
